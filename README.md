...
```
1. mkdir -p InFusionX-p1 && cd InFusionX-p1

2. Initialize your local repository using the LineageOS trees with a command
  repo init -u git://github.com/LineageOS/android.git -b lineage-16.0
  
3. Clone this repo:
  git clone https://github.com/leleobhz/android_local_manifests_p1 .repo/local_manifests -b lineage-16.0
